...
export class StartupSyncService implements OnModuleInit {
  ...
  async onModuleInit() {
    ...
    this.logger.log('Application started - startup sync disabled. Sync will run only when triggered from frontend.');
    this.logger.log('Waiting for frontend login to trigger initial and periodic sync...');
  }
